  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto bg-bl4ck">
        <DialogHeader>
          <DialogTitle><span className="font-serif font-normal text-2xl text-white">Request Resume Access</span></DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          >
            ...
            <span className="relative text-black group-hover:text-white">Submit Request</span>
          </button>
